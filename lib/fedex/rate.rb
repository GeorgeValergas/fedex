module Fedex
  ...
  class Rate
    ...
    #     @total_duties_and_taxes #The total duties and taxes
    #     @duties_and_taxes #Breakdown of duties and taxes
    attr_accessor :service_type, :transit_time, :rate_type, :rate_zone, :total_billing_weight, :total_freight_discounts, :total_net_charge, :total_taxes, :total_net_freight, :total_surcharges, :total_base_charge, :total_duties_and_taxes, :duties_and_taxes
    def initialize(options = {})
      ...
      @duties_and_taxes = options[:duties_and_taxes]
    end
  end
end
